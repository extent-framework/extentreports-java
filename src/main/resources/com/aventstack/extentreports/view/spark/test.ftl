	                                                                ...
	                                                                <div class="collapse">
	                                                                    <div class="card-body">
	                                                                        <#list node.nodeContext.all as child>
	                                                                        	<#assign cls="">
	                                                                            <#if child.hasChildren()><#assign cls="ml-3"><div class="card"></#if>
	                                                                            <div class="">
	                                                                                <div class="node" title="${child.description}">${child.name}</div>
	                                                                                <div class="${cls} status-avatar float-left ${child.status}-bg">
	                                                                            ...
	                                                                            <#if child.hasChildren()>
		                                                                        	...
		                                                                        	<#list child.nodeContext.all as gc>
		                                                                                <div class="node" title="${gc.description}">${gc.name}</div>
		                                                                                <div class="status-avatar float-left ${gc.status}-bg">
		                                                                                    <i class="fa fa-${Icon.getIcon(gc.status)} text-white"></i>
		                                                                                </div>
		                                                                                <div class="node-description"></div>
		                                                                                <#if gc.hasLog()>
