...
public class ExtentTestMediaTest {
    ...
    private static final String BASE64 = 
            "iVBORw0KGgoAAAANSUhEUgAAAY4AAABbCAYAAABkgGJUAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsMAAA7DAcdvqGQAABIMSURBVHhe7Z3" +
    ...
    public void addScreenCaptureFromPathNodeLog() {
        ...
        Assert.assertEquals(node.getModel().getLogs().get(0).getMedia().get(0).getPath(), PATH);
    ...
    public void addScreenCaptureFromBase64TestLog() {
        ...
        Assert.assertEquals(test.getModel().getMedia().size(), 0);
        Assert.assertEquals(test.getModel().getLogs().get(0).getMedia().size(), 1);
        Assert.assertEquals(((ScreenCapture)test.getModel().getLogs().get(0).getMedia().get(0)).getBase64(), BASE64_ENCODED + BASE64);
        Assert.assertEquals(test.getModel().getLogs().get(0).getMedia().get(0).getTitle(), TITLE);
    }
